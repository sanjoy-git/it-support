...
export default function Footer() {
  return (
    <div className='w-full h-auto p-1 mt-10 rounded-t-lg bg-gradient-to-r from-blue-700 to-blue-500'>
      ...
      <div className='border-t-2 border-stone-500'>
        <p className='text-sm text-center text-slate-800'>Techacademybd @2020-2025 - All Rights Reserved</p>
      </div>
